...
public class HaloView1 extends View implements Runnable {
    ...
    public HaloView1(Context context) {
        super(context);
        setOffset();
    }

    public HaloView1(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setOffset();
    }

    public HaloView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        setOffset();
    }
