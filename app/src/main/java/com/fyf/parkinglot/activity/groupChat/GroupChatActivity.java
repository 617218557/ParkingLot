...
public class GroupChatActivity extends AppCompatActivity {
    ...
    private void setListener() {
        ...
        btn_sendMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(GroupChatActivity.this).setItems(items, new DialogInterface.OnClickListener() {
                    @Override
    ...
    private void init() {
        ...
        groupChatListAdapter = new GroupChatListAdapter(GroupChatActivity.this, conversation.getAllMessages());
        lv_message.setAdapter(groupChatListAdapter);
        lv_message.setSelection(ListView.FOCUS_DOWN);
    }
    ...
    protected void sendTextMessage(String content) {
        EMMessage message = EMMessage.createTxtSendMessage(content, toChatGroup.getGroupId());
        message.setChatType(EMMessage.ChatType.GroupChat);
        sendMessage(message);
    }

    protected void sendVoiceMessage(String filePath, int length) {
        EMMessage message = EMMessage.createVoiceSendMessage(filePath, length, toChatGroup.getGroupId());
        message.setChatType(EMMessage.ChatType.GroupChat);
        sendMessage(message);
    }

    protected void sendImageMessage(String imagePath) {
        EMMessage message = EMMessage.createImageSendMessage(imagePath, false, toChatGroup.getGroupId());
        message.setChatType(EMMessage.ChatType.GroupChat);
        sendMessage(message);
    }

    protected void sendLocationMessage(double latitude, double longitude, String locationAddress) {
        EMMessage message = EMMessage.createLocationSendMessage(latitude, longitude, locationAddress, toChatGroup.getGroupId());
        message.setChatType(EMMessage.ChatType.GroupChat);
        sendMessage(message);
    }

    protected void sendVideoMessage(String videoPath, String thumbPath, int videoLength) {
        EMMessage message = EMMessage.createVideoSendMessage(videoPath, thumbPath, videoLength, toChatGroup.getGroupId());
        message.setChatType(EMMessage.ChatType.GroupChat);
        sendMessage(message);
    }

    protected void sendFileMessage(String filePath) {
        EMMessage message = EMMessage.createFileSendMessage(filePath, toChatGroup.getGroupId());
        message.setChatType(EMMessage.ChatType.GroupChat);
        sendMessage(message);
    }
    ...
    private void sendImage(int requestCode, Intent data) {
        try {
            ...
            imgPath = uri2filePath(imageUri, GroupChatActivity.this);
            sendImageMessage(imgPath);
        } catch (Exception e) {
            e.printStackTrace();
